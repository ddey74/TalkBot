...
//        String tell="type your message here";
//        tts.speak(tell,TextToSpeech.QUEUE_ADD,null);
    ...
    public void go7(View v)
    {
        ...
        tv6.setText("To Whom Do You Want To Message?");
        ...
        public void onResults(Bundle bundle)
        {
            ...
            if(name.equals(" "))
            {
                ...
                if (!contactnum.equals("contact not found"))
                {
                    ...
                    Intent smsintent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + contactnum));
